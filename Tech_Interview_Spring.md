...
스프링은 내부에서 컨테이너를 통해 자바 객체의 생명주기를 관리하며, 의존관계 주입(DI)을 통해 객체지향 설계를 할 수 있도록 도와줍니다.
또한, 스프링은 AOP(Aspect Oriented Programming)를 지원하여, 트랜잭션, 보안, 로깅 등의 관심사를 분리하여 모듈화할 수 있습니다.
